...
class CaneraWithMaskFiltersScreen extends StatefulWidget {
  CaneraWithMaskFiltersScreen({Key key}) : super(key: key);

  @override
  _CaneraWithMaskFiltersScreenState createState() =>
      _CaneraWithMaskFiltersScreenState();
}

class _CaneraWithMaskFiltersScreenState
    extends State<CaneraWithMaskFiltersScreen> {
